...
% FuncDimension = number of your variables
...
Best_universe=zeros(1,FuncDimension);
Best_universe_Inflation_rate=inf;

%Initialize the positions of universes

Universes=random_pop(PopSize,FuncDimension,ub,lb);
...
while Time<MaxIteration+1
    ...
    TDR=1-((Time)^(1/6)/(MaxIteration)^(1/6));
